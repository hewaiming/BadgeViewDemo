...
import q.rorbin.badgeview.demo.R;
...
public class RecyclerViewActivity extends Activity {
	...
	class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.Holder> {
		...
		public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
			return new Holder(
					LayoutInflater.from(RecyclerViewActivity.this).inflate(R.layout.item_view, parent, false));
		}
				...
				badge.setOnDragStateChangedListener(new Badge.OnDragStateChangedListener() {
					...
					public void onDragStateChanged(int dragState, Badge badge, View targetView) {
						if (dragState == STATE_SUCCEED) {
							Toast.makeText(RecyclerViewActivity.this, String.valueOf(getAdapterPosition()),
